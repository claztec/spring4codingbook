 ...
 */
public class CacheModule implements MethodInterceptor {
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        if ("findByType".equals(invocation.getMethod().getName()) && invocation.getArguments().length == 1 && invocation.getArguments()[0] instanceof Type) {
