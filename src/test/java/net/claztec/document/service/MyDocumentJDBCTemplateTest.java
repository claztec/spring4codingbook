...
public class MyDocumentJDBCTemplateTest {

    private static final Logger log = LoggerFactory.getLogger(MyDocumentJDBCTemplateTest.class);
    ...
    @Test
    public void testUsingSprinJDBCTemplate() {
